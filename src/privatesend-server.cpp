...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Qwartz related functionality
...
/*
    ...
    allow endless transaction that would bloat Qwartz and make it unusable. To

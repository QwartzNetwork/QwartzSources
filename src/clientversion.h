...
//! These need to be macros, as clientversion.cpp's and qwartz*-res.rc's voodoo requires it
...
/**
 * qwartzd-res.rc includes this file, but it cannot cope with real c++ code.

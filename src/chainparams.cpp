 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1553772611, nBits=1e0ffff0, nNonce=684250, vtx=1)
...
{
    const char* pszTimestamp = "Qwartz Network Mars 2019";
    const CScript genesisOutputScript = CScript() << ParseHex("04c187edbec5f2d921a4492b184abc546eb399b1403e4ef3003c06156d6b31e48efbaddc162c857be4bd108d8d5019764bf4c00ed11a8d7e4ab9f5ea166fc4c30f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        // Qwartz BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Qwartz BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Qwartz BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkAddress = "QZgtce5SnMjz4MJsiQRYjrf4xAvqDjDyLu";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000cbc316a4de8c8bf79dfa04bfe05d019866fce66d3d6708a1cc8df1e0d82"))
        };

        chainTxData = ChainTxData{
            1553772611, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000049f3eef5f1bf93ac309ed7c807878566d88c4f7b6a4c460a99466eeb57d"); 
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000049f3eef5f1bf93ac309ed7c807878566d88c4f7b6a4c460a99466eeb57d"));
        assert(genesis.hashMerkleRoot == uint256S("0xfe4a1d6ca2e93f9aa9d3f86a799fa3b52b5b39a69e984c7dae8e909343c75009"));
        ...
        // Testnet Qwartz BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Qwartz BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Qwartz BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        strSporkAddress = "ZRzCwun8TuDS4xLJk13bAWVjgdX6SsA1S1";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000049f3eef5f1bf93ac309ed7c807878566d88c4f7b6a4c460a99466eeb57d"))
        };

        chainTxData = ChainTxData{        
            1553772616, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1553772621, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5da03df405c242a34220c1f9662f4fc78f0148aef3303d4bbf897fcdceb58461"));
        assert(genesis.hashMerkleRoot == uint256S("0xfe4a1d6ca2e93f9aa9d3f86a799fa3b52b5b39a69e984c7dae8e909343c75009"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("qwartzevo.org",  "devnet-seed.qwartzevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x5da03df405c242a34220c1f9662f4fc78f0148aef3303d4bbf897fcdceb58461"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7ypwpc2HMAsvdhVs3Ub5bFLSCDGr22pifrYYSXyBgXZrnLcBfXY
        strSporkAddress = "ZZJdxVtLeRBzBcXK2FYtfAF6zh5FRwwEXa";
        ...
        // Regtest Qwartz addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,80);
        // Regtest Qwartz script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,81);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,208);
        // Regtest Qwartz BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Qwartz BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Qwartz BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }

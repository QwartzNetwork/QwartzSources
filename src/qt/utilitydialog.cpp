    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  qwartz-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Qwartz in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QWARTZ, 0.1 QWARTZ, 1 QWARTZ and 10 QWARTZ -- sort of like the paper money you use every day.</li> \

    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QWARTZ-light"), QVariant("light"));
    ui->theme->addItem(QString("QWARTZ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("QWARTZ-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("QWARTZ-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("QWARTZ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QWARTZ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QWARTZ-traditional"), QVariant("trad"));

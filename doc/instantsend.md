...
This mechanism has been integrated into Bitcore-Node-Qwartz which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qwartzpay/insight-api-qwartz#web-socket-api](https://github.com/qwartzpay/insight-api-qwartz#web-socket-api)
* API: [https://github.com/qwartzpay/insight-api-qwartz#instantsend-transactions](https://github.com/qwartzpay/insight-api-qwartz#instantsend-transactions)
...
By default, the Qwartz Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qwartz Core daemon:

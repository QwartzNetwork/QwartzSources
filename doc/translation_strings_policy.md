...
This document provides guidelines for internationalization of the Qwartz Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qwartz_en.ts` remains unchanged.
